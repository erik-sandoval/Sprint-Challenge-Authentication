...
sessions store your information, then the session is store in a cookie, because http is stateless by default.

1. What does bcrypt do to help us store passwords in a secure manner.
It hashes the passwords for us a preconfigured amount of times.

1. What does bcrypt do to slow down attackers?
It lets you preconfigure how many times you want to salt a password. Which in turn slows down the atackers by making them have to unsalt your password that many times.

1. What are the three parts of the JSON Web Token?
The three parts of a JSON Web Token are the payload, secret key, and options. 
